                                    ...
                                    switch (SubDataCode)
                                    {
                                        ...
                                        case 0x03: // smbus register dump   
                                            ...
                                            if (Payload.Length > 2)
                                            {
                                                ...
                                                int[] all_block_reads_4050 = {ManufacturerName
                                                                            ,DeviceName
                                                                            ,DeviceChemistry
                                                                            ,ManufacturerData
                                                                            ,SafetyAlert
                                                ...
                                                int[] all_block_reads_3060 = {ManufacturerName
                                                                            ,DeviceName
                                                                            ,DeviceChemistry
                                                                            ,ManufacturerData};
                                                ...
                                                for (int i = 1; i < (Payload.Length - 2); i++)
                                                {
                                                    ...
                                                    if (all_block_reads_4050.Contains(iterate_reg))
                                                    {
                                                        if ((iterate_reg > 0x24))
                                                        {
                                                            if ((listOfByteArrays[0x21].Length == 0x06))
                                                            {
                                                ...
                                                for (int i = 0; i < SMBusRegisterDumpList.Count; i++)
                                                    {
                                                        ...
                                                        switch (current_reg)
                                                        {
                                                            ...
                                                            case 0x23:
                                                                ...
                                                                //Util.UpdateTextBox(CommunicationTextBox, "ZERO COUNT???" + Convert.ToString(zeroCount), null);
                                                                // zero count kemur ut sem 11, held ad thad er ekkert ad lesast ur thessum register a BQ3060!
                                                                ...
                                                                value.Append("ManufacturerData: virdist ekkert lesast ur tessum register");
                                                                break;
                                                            case 0x3C:
                                                                Double CellVoltage4 = SMBusRegisterDumpList[i] / 1000D;
                                                                value.Append("Cell voltage 4: " + CellVoltage4 + " V");
                                                                break;
                                                            case 0x3D:
                                                                Double CellVoltage3 = SMBusRegisterDumpList[i] / 1000D;
                                                                value.Append("Cell voltage 3: " + CellVoltage3 + " V");
                                                                break;
                                                            case 0x3E:
                                                                Double CellVoltage2 = SMBusRegisterDumpList[i] / 1000D;
                                                                value.Append("Cell voltage 2: " + CellVoltage2 + " V");
                                                                break;
                                                            case 0x3F:
                                                                Double CellVoltage1 = SMBusRegisterDumpList[i] / 1000D;
                                                                value.Append("Cell voltage 1: " + CellVoltage1 + " V");
                                                                break;
                                                            case 0x4A:
                                                                value.Append("BTP discharge set: " + SMBusRegisterDumpList[i].ToString() + " mAh");
                                                                break;
                                                            case 0x4B:
                                                                value.Append("BTP charge set: " + SMBusRegisterDumpList[i].ToString() + " mAh");
                                                                break;
                                                            case 0x4F:
                                                            ...
                                                            case 0x52: //thetta er H4 (32 bit) veit ekki hvort kemur ut rett her!
                                                                value.Append("PFAlert: " + Convert.ToString(SMBusRegisterDumpList[i], 2).PadLeft(16, '0'));
                                                                //+ Convert.ToString(listOfByteArrays[current_reg][1], 2).PadLeft(8, '0') + " "
                                                                //+ Convert.ToString(listOfByteArrays[current_reg][0], 2).PadLeft(8, '0'));
                                                                break;
                                                            case 0x53: //thetta er H4 (32 bit) veit ekki hvort kemur ut rett her!
                                                                value.Append("PFStatus: " + Convert.ToString(SMBusRegisterDumpList[i], 2).PadLeft(16, '0'));
                                                                //+ Convert.ToString(listOfByteArrays[current_reg][1], 2).PadLeft(8, '0') + " "
                                                                //+ Convert.ToString(listOfByteArrays[current_reg][0], 2).PadLeft(8, '0'));
                                                                break;
                                                            ...
                                                            case 0x57: //thetta er H4 (32 bit) veit ekki hvort kemur ut rett her!
                                                                value.Append("Reset data: " + Convert.ToString(SMBusRegisterDumpList[i], 2).PadLeft(16, '0'));
                                                                //+ Convert.ToString(listOfByteArrays[current_reg][1], 2).PadLeft(8, '0') + " "
                                                                //+ Convert.ToString(listOfByteArrays[current_reg][0], 2).PadLeft(8, '0'));
                                                                break;
                                                            case 0x59:
                                                ...
                                                for (int i = 0; i < SMBusRegisterDumpList.Count; i++)
                                                {
                                                    ...
                                                    switch (current_reg)
                                                    {
                                                        ...
                                                        case 0x59:
                                                            ...
                                                            break;
                                                        case 0x5A:
                                                            value.Append("Sus Turbo Power: " + SMBusRegisterDumpList[i].ToString() + " cW");
                                                            break;
                                                        case 0x5B:
                                                            value.Append("Turbo Pack Resistance: " + SMBusRegisterDumpList[i].ToString() + " mOhm");
                                                            break;
                                                        case 0x5C:
                                                            value.Append("Turbo System Resistance: " + SMBusRegisterDumpList[i].ToString() + " mOhm");
                                                            break;
                                                        case 0x5D:
                                                            value.Append("Turbo EDV: " + SMBusRegisterDumpList[i].ToString() + " mV");
                                                            break;
                                                        case 0x5E:
                                                            value.Append("Max Turbo Current: " + SMBusRegisterDumpList[i].ToString() + " mA");
                                                            break;
                                                        case 0x5F:
                                                ...
                                                for (int i = 0; i < listOfByteArrays.Count; i++)
                                                {
                                                    Util.UpdateTextBox(CommunicationTextBox, Util.ByteToHexString(new byte[] { (byte)i }, 0, 1) + ": " + Util.ByteToHexString(listOfByteArrays[i], 0, listOfByteArrays[i].Length), null);
                                                }
                                            }
                                            break;
